    ...
    <div className={styles.content}>
      <div className={styles.content_goodfor}>
        ...
        <div className={styles.content_goodfor_items}>
          <div className={styles.content_goodfor_item}>
            <div className={styles.content_goodfor_item_img} />
      ...
      <div className={styles.content_cooknotes}>
        ...
        <p className={styles.content_cooknotes_text}>
          ...
          temporibus, sed a soluta vero odit possimus laboriosam quisquam. Amet
          nesciunt sint architecto rerum molestias nisi excepturi sequi cum ad
          voluptate. Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Similique hic id beatae rerum dolorum sapiente quisquam facilis, fuga
          aliquam commodi ea magnam tempore, amet odit odio assumenda debitis
          accusamus culpa.
        </p>
      </div>
      <div className={styles.content_whyitsgood}>
        ...
        <div className={styles.content_whyitsgood_text}>
          ...
          vitae tempore consequuntur voluptatibus, fugit quis qui dolor
          obcaecati facere quas debitis vero eveniet? Saepe molestiae
          consectetur blanditiis sed optio! Lorem ipsum dolor sit amet,
          consectetur adipisicing elit. Quibusdam nobis blanditiis suscipit illo
          vero hic velit atque? Quidem magnam hic, sunt nesciunt veniam iusto
          dolorum fugiat cupiditate, ratione, officiis excepturi?
        </div>
      </div>
    </div>
  </div>
